...
export function ExportMenu({ onExcel, onCsv, onPdf, disabled, label = 'Export' }: ExportMenuProps) {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 top-full z-20 mt-2 w-48 overflow-hidden rounded-xl border border-ink-100 bg-white py-1.5 shadow-card-hover animate-fade-in">
          {onExcel && (
            <button
              type="button"
